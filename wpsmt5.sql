...
(1, 'Refnandida Arlan F', 'Tangerang', 'laki-laki', 'islam', 'SMAN', '01'),
(4, 'Ahmad Sodrul', 'Jakarta', 'Laki-laki', 'Islam', 'SMKN', '01'),
(5, 'Herni Irma Wati', 'Tangerang', 'Perempuan', 'Islam', 'SMAN', '02'),
(6, 'Agung Maulana', 'Depok', 'Laki-laki', 'Islam', 'SMAN', '01'),
(7, 'Romadoni', 'Jatake', 'Laki-laki', 'Islam', 'SMKN', '02');
